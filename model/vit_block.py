...
class VisionTransformer(nn.Module):
    ...
    def test(self, device='cpu'):
        input_tensor = torch.rand(1, 1, 224, 224)     # 196 为在Embeddings中的 n_patches （14 * 14）
...
#     # net3 = Transformer(config_vit, img_size=224)
#     # net3.test()

#     net4 = VisionTransformer(config_vit,  img_size=224, num_classes=9)
#     net4.test()
