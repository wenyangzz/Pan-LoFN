...
class Testsolver(BaseSolver):
    ...
    def test(self):
        ...
        for batch in self.data_loader:
            ...
            t0 = time.time()
            with torch.no_grad():
                prediction,_,_,r1,r2 = self.model(lms_image, bms_image, pan_image)
            t1 = time.time()
            ...
            self.save_img(r1.cpu().data, name[0][0:-4] + '_r1.tif', mode='CMYK')
            self.save_img(r2.cpu().data, name[0][0:-4] + '_r2.tif', mode='CMYK')
