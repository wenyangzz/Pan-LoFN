...
class Solver(BaseSolver):
    def __init__(self, cfg):
        ...
        self.optimizer = maek_optimizer(self.cfg['schedule']['optimizer'], cfg,
                                        [{"params": self.model.parameters()}, {"params": self.model_t.parameters()}])
        ...
        # save log
        self.writer = SummaryWriter('/ghome/fuxy/DPFN-master-WV2/log/' + str(self.log_name))
        save_net_config(self.log_name, self.model)
        save_yml(cfg, os.path.join('/ghome/fuxy/DPFN-master-WV2/log/' + str(self.log_name), 'config.yml'))
