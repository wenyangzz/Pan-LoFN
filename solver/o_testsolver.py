...
class Testsolver(BaseSolver):
    ...
    def test(self):
        ...
        # print(name)
        ref_results,no_ref_results = cal_performance(os.path.join(self.cfg['test']['data_dir'], "ms"), os.path.join(self.cfg['test']['data_dir'], "pan"), os.path.join(self.cfg['test']['save_dir'], self.cfg['test']['type']+ "_" + str(self.cfg['stage']) + 'stage', str(self.now_time)))
